...
| 步骤 | 任务 | 触发时机 | 通知对象 | 状态 |
|:----:|------|---------|---------|:----:|
| 6-5-1 | 消息模板申请 + 通用发送模块 | — | — | ⬜ 待开发 |
| 6-5-2 | 申请提交通知 | operator 提交出库申请 | 所有 manager/admin | ⬜ 待开发 |
| 6-5-3 | 审批结果通知 | manager 审批通过/驳回 | 申请人 (operator) | ⬜ 待开发 |
| 6-5-4 | 安全库存预警通知 | 入库/出库导致库存低于阈值 | 所有 manager/admin | ⬜ 待开发 |
